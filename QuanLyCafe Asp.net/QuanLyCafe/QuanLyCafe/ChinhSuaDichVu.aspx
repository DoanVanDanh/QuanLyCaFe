<%@ Page Title="" Language="C#" MasterPageFile="~/QuanTri.master" AutoEventWireup="true" CodeBehind="ChinhSuaDichVu.aspx.cs" Inherits="QuanLyCafe.ChinhSuaDichVu" %>
<asp:Content ID="Content1" ContentPlaceHolderID="header" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="mainContent" runat="server">
        <p style="color:red;font-size:20px" >
              Chỉnh sửa DichVụ: phải nhập đầy đủ thông tin
              <br/>
            XÓa dịch Vụ: chỉ cần nhập Mã Dịch Vụ cần xóa
...
<asp:RegularExpressionValidator ID="regexValidator" runat="server"
    ...
    <br />
    <asp:Button ID="btChinhSua" runat="server" Text="Chỉnh sửa" OnClick="btChinhSua_Click" />
        <asp:Button ID="btXoa" runat="server" OnClick="btXoa_Click" Text="Xóa dịch vụ" />
    <br />
    <p>
