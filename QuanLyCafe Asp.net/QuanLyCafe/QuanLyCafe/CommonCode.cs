...
namespace CommonCode
{
    ...
    namespace DataClasses
    {
        ...
        public class DataTool
        {
            ...
            /// <param name="sqlParams">Mang chua cac doi tuong tham so de thuc hien lenh insert/update/delete</param>
            /// <returns></returns>
        ...
        public class WebClass
        {
            public static string getConnectionStringByName(string connectionStringName)
            {
                ...
                System.Configuration.Configuration rootWebConfig =
                    System.Web.Configuration.WebConfigurationManager.OpenWebConfiguration("/QuanLyCafe");//ten website = project
                System.Configuration.ConnectionStringSettings connString;


                if (rootWebConfig.ConnectionStrings.ConnectionStrings.Count > 0)//duyệt từng <add name=""/>
                {
                    connString =
